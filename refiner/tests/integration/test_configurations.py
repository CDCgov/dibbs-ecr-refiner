...
import app.db.configurations.activations.db as db_mod
...
class TestConfigurations:
    ...
    async def test_activate_rollback(self, setup, authed_client, db_conn, monkeypatch):
        # Get a configuration from the created config
        async with db_conn.cursor() as cur:
            await cur.execute(
                """

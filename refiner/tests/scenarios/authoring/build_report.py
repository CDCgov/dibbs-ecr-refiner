...
ROLLUP_COVERAGE: list[RollupRow] = [
    ...
    RollupRow(
        ...
        evidence=(
            ...
            "single custom code; the snapshot pins panel pruning at a "
            "one-of-nine cardinality. `covid_with_multi_vital_sign_codes` "
            "adds three vital sign codes (8867-4, 8480-6, 9279-1) and pins "
            "the three-of-nine case. If the bug returned, both snapshots "

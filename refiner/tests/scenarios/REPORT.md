...
| Augmented eICR id | `c837e464-878c-58e7-bfcb-4999ad453858` |
| Augmented RR id | `b4e8d85e-20e5-5962-b72f-c000fd9282d0` |
...
| `10164-2` | HISTORY OF PRESENT ILLNESS | 0 | stubbed (no matches) |
...
| `10187-3` | REVIEW OF SYSTEMS | 0 | stubbed (no matches) |
| `11450-4` | Problem List | 1 | refined or retained |
| `10154-3` | Chief complaint Narrative - Reported | 0 | stubbed (no matches) |
| `29299-5` | Reason for visit Narrative | 0 | stubbed (no matches) |
...
| `29762-2` | Social History | 1 | refined or retained |
| `90767-5` | Pregnancy summary Document | 1 | refined or retained |
| `8716-3` | Vital Signs | 0 | removed by configuration |
| `83910-0` | Public health Note | 2 | refined or retained |
...
| Augmented eICR id | `238184e6-ae46-5219-8064-bc3515e48392` |
| Augmented RR id | `52caa323-586c-52c4-959d-dd2decb7a4bc` |
| Original eICR id | `2.16.840.1.113883.9.9.9.9.9` |
| Original RR id | `329b9b59-c1be-4036-8984-42266155b321` |

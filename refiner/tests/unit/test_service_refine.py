...
def _make_db_configuration_v1_1(**kwargs) -> DbConfiguration:
    ...
    defaults = {
        ...
        "primary_condition_id": "fake-condition-id-v1-1",
        "original_condition_id": "fake-condition-id-v1-1",
        "status": "active",
        "version": 1,
        "included_conditions": [],
        "custom_codes": [],
...
def _make_db_configuration_v3_1_1(**kwargs) -> DbConfiguration:
    ...
    defaults = {
        ...
        "jurisdiction_id": "SDDH",
        "primary_condition_id": "fake-condition-id-v3-1-1",
        "original_condition_id": "fake-condition-id-v3-1-1",
        "status": "active",
        "version": 1,
        "included_conditions": [],
        "custom_codes": [],

...
In order to run the container commands against the Refiner demo environment, you'll need the DB demo creds. Get this from a developer on the team.

Make sure you have the correct ops image installed locally from which to run the commands (ie, if you're deploying tagged image 0.0.12, make sure the ops image tag matches the tag for the image you're seeking to deploy).

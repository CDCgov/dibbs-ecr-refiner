...
# SCRIPT_DIR is .../database/pipeline/
# DATABASE_DIR is .../database/
...
def main() -> None:
    ...
    # 1: setup
    print(f"🧹 Setting up staging area at: {STAGING_DIR.relative_to(DATABASE_DIR)}")
    ...
    if MANIFEST_PATH.exists():
        print(
            f"🔎 Found existing manifest at: {MANIFEST_PATH.relative_to(DATABASE_DIR)}"
        )

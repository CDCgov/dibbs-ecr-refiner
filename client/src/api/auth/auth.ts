 ...
 * @summary Login
 */
export const loginApiLoginGet = (
  options?: AxiosRequestConfig
): Promise<AxiosResponse<unknown>> => {
  return axios.default.get(`/api/login`, options);
};

export const getLoginApiLoginGetQueryKey = () => {
  return [`/api/login`] as const;
};

export const getLoginApiLoginGetQueryOptions = <
  TData = Awaited<ReturnType<typeof loginApiLoginGet>>,
  TError = AxiosError<unknown>,
>(options?: {
  query?: Partial<
    UseQueryOptions<Awaited<ReturnType<typeof loginApiLoginGet>>, TError, TData>
  >;
  axios?: AxiosRequestConfig;
}) => {
  const { query: queryOptions, axios: axiosOptions } = options ?? {};

  const queryKey = queryOptions?.queryKey ?? getLoginApiLoginGetQueryKey();

  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof loginApiLoginGet>>
  > = ({ signal }) => loginApiLoginGet({ signal, ...axiosOptions });
...
export type LoginApiLoginGetQueryResult = NonNullable<
  Awaited<ReturnType<typeof loginApiLoginGet>>
>;
export type LoginApiLoginGetQueryError = AxiosError<unknown>;

export function useLoginApiLoginGet<
  TData = Awaited<ReturnType<typeof loginApiLoginGet>>,
  TError = AxiosError<unknown>,
>(
  options: {
...
>(
  ...
  const queryOptions = getLoginApiLoginGetQueryOptions(options);
 ...
 */
export const authCallbackApiAuthCallbackGet = (
  options?: AxiosRequestConfig
): Promise<AxiosResponse<unknown>> => {
  return axios.default.get(`/api/auth/callback`, options);
};

export const getAuthCallbackApiAuthCallbackGetQueryKey = () => {
  return [`/api/auth/callback`] as const;
};

export const getAuthCallbackApiAuthCallbackGetQueryOptions = <
  TData = Awaited<ReturnType<typeof authCallbackApiAuthCallbackGet>>,
  TError = AxiosError<unknown>,
>(options?: {
  query?: Partial<
    UseQueryOptions<
      Awaited<ReturnType<typeof authCallbackApiAuthCallbackGet>>,
      TError,
      TData
    >
  >;
  ...
  const queryKey =
    queryOptions?.queryKey ?? getAuthCallbackApiAuthCallbackGetQueryKey();

  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof authCallbackApiAuthCallbackGet>>
  > = ({ signal }) =>
    authCallbackApiAuthCallbackGet({ signal, ...axiosOptions });
...
export type AuthCallbackApiAuthCallbackGetQueryResult = NonNullable<
  Awaited<ReturnType<typeof authCallbackApiAuthCallbackGet>>
>;
export type AuthCallbackApiAuthCallbackGetQueryError = AxiosError<unknown>;

export function useAuthCallbackApiAuthCallbackGet<
  TData = Awaited<ReturnType<typeof authCallbackApiAuthCallbackGet>>,
  TError = AxiosError<unknown>,
>(
  options: {
...
>(
  ...
  const queryOptions = getAuthCallbackApiAuthCallbackGetQueryOptions(options);
 ...
 * @summary Logout
 */
export const logoutApiLogoutGet = (
  options?: AxiosRequestConfig
): Promise<AxiosResponse<unknown>> => {
  return axios.default.get(`/api/logout`, options);
};

export const getLogoutApiLogoutGetQueryKey = () => {
  return [`/api/logout`] as const;
};

export const getLogoutApiLogoutGetQueryOptions = <
  TData = Awaited<ReturnType<typeof logoutApiLogoutGet>>,
  TError = AxiosError<unknown>,
>(options?: {
  query?: Partial<
    UseQueryOptions<
      Awaited<ReturnType<typeof logoutApiLogoutGet>>,
      TError,
      TData
    >
  >;
  ...
  const queryKey = queryOptions?.queryKey ?? getLogoutApiLogoutGetQueryKey();

  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof logoutApiLogoutGet>>
  > = ({ signal }) => logoutApiLogoutGet({ signal, ...axiosOptions });
...
export type LogoutApiLogoutGetQueryResult = NonNullable<
  Awaited<ReturnType<typeof logoutApiLogoutGet>>
>;
export type LogoutApiLogoutGetQueryError = AxiosError<unknown>;

export function useLogoutApiLogoutGet<
  TData = Awaited<ReturnType<typeof logoutApiLogoutGet>>,
  TError = AxiosError<unknown>,
>(
  options: {
...
>(
  ...
  const queryOptions = getLogoutApiLogoutGetQueryOptions(options);

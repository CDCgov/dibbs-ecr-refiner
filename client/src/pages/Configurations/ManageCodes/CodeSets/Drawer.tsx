      ...
      <div>
        <div
          className={classNames(
            'bg-gray-2 fixed top-0 z-drawer flex h-full w-full shrink-0 flex-col items-start gap-6 border-l border-solid border-gray-400 p-0 shadow-2xl transition-all duration-300 ease-linear',
            {

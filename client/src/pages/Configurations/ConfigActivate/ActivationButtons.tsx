...
export function ActivationButtons({
  ...
  useEffect(() => {
    ...
    if (currentVersionIsActive) {
      ...
      newButtonState['switchFromPrevious'] = true;
    }
  ...
  return (
    <div className="mt-6">
      {buttonState['switchFromPrevious'] && (
      ...
      {buttonState['activate'] && (
        <div>
          ...
          <ActivationConfirmationModal
            ...
            switchFromPrevious={buttonState['switchFromPrevious']}
      ...
      {buttonState['deactivate'] && (
        <div>
          <Button variant="secondary" onClick={handleDeactivation}>
...
function ActivationConfirmationModal({
  ...
  const modalContent = switchFromPrevious
    ? {
    ...
    : {
        ...
        body: (
          <div>
            <ul>
              <li>
                Refiner will <span className="text-bold">immediately</span>{' '}
                start to refine the eCR's
              </li>
              <li>
  ...
  return (
    ...
    >
      <ModalHeading id="activation-confirmation-modal-heading">
        <div className="mb-6">{modalContent.title}</div>
      </ModalHeading>
      {modalContent.body}

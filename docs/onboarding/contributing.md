...
More information on the code generation setup can be found in the [client package's README](./onboarding/contributing.md).
...
You'll also notice that we've added a few properties to our route. We will want to include all of these properties each time we create a new route. Please refer to the [client package README `Requirements` section](./onboarding/contributing.md#requirements) for more detail on each of these properties and why they are needed.
